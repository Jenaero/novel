...
public class BxwxNovelStorageImplDemo extends AbstractNovelStorage {
	public BxwxNovelStorageImplDemo() throws FileNotFoundException {
	...
	public BxwxNovelStorageImplDemo(String confPath) throws FileNotFoundException {
		super(confPath);
		tasks.put("0","https://www.bxwx9.org/binitial1/0/1.htm");
		for(int i=0;i<=25;i++){
			String letter=(char)(i+'A')+"";	
