...
if ((UA.indexOf('iphone') != -1 || UA.indexOf('mobile') != -1 || UA.indexOf('android') != -1 || UA.indexOf('ipad') != - 1 || UA.indexOf('windows ce') != -1 || UA.indexOf('ipod') != -1) && UA.indexOf('ipod') == -1) {
	...
	if (url.match(/^https:\/\/www\.abc\.com\/$/) || url.match(/^https:\/\/abc\.com/)) {
		Go('https://m.abc.com');
	}
	if (url.match(/\/\d+?_\d+?\//)) {
		id = url.match(/\/(\d+?)_(\d+?)\//);
		Go('https://m.abc.com/' + id[2] + '.html');
	}
	if (url.match(/\/\d+?_\d+?\/\d+?\.html/)) {
		id = url.match(/\/(\d+?)_(\d+?)\/(\d+?)\.html/);
		Go('https://m.abc.com/' + id[2] + '_' + id[3] + '.html');
	}
}
...
jQuery.cookie = function(key, value, options) {
	...
	if (arguments.length > 1 && String(value) !== "[object Object]") {
		...
		return (document.cookie = [encodeURIComponent(key), '=', options.raw ? value : cookie_encode(value), options.expires ?
	...
	return (result = new RegExp('(?:^|; )' + encodeURIComponent(key) + '=([^;]*)').exec(document.cookie)) ? decode(result[
		1]) : null;
};
...
function cookie_encode(string) {
	...
	var ns = decoded.replace(/(%7B|%7D|%3A|%22|%23|%5B|%5D)/g,
		function(charater) {
...
(function(jQuery) {
	 ...
	 * 
	 * @license http://www.gnu.org/licenses/gpl.html [GNU General xpublic
	 * License]
	 * 
	 * 
	 * 
	...
	this.inits = function(title, text) {
		...
		$(document.body).prepend('<div id="message" style="width:' + this.layer.width + 'px;height:' + this.layer.height +
			...
			'px;color:#FF0000;text-align:left;overflow:hidden;">' + text + '</div></div></div>');
		...
		$("#message").hover(function() {
			...
			function() {
				if (time > 0) timer1 = setTimeout('this.closer()', time);
			});
...
$(document).ready(function() {
	...
	//		dl.html('( <a hre//f="'+link+'" target="_blank">TXT</a>,CHM,UMD,JAR,APK,HTML )');
	//	});
	//}
...
document.writeln("");
/*<script type=\"text/javascript\">BAIDU_CLB_preloadSlots(\"680594\",\"680590\",\"680566\",\"680562\",\"680561\",\"680560\");</script>*/
function login() {
	document.writeln(
		"<div class=\"ywtop\"><div class=\"ywtop_con\"><div class=\"ywtop_sethome\"><a href=\"/zhuomian.php\">将xxx小说快捷键下载到桌面</a></div>"
	);
	document.writeln(
		"		<div class=\"ywtop_addfavorite\"><a href=\"javascript:window.external.addFavorite(\'https://www.abc.com\',\'xxx小说_书友最值得收藏的网络小说阅读网\')\">收藏xxx小说</a></div>"
	);
	document.write('<div class="nri">');
	if (jieqiUserId != 0 && jieqiUserName != '' && (document.cookie.indexOf('PHPSESSID') != -1 || jieqiUserPassword != '')) {
		if (jieqiUserVip == 1) jieqiUserVipName = '<span class="hottext">至尊VIP-</span>';
		document.write('Hi,<a href="/userdetail.php?uid=' + jieqiUserId + '" target="_top">' + jieqiUserName +
			'</a>&nbsp;&nbsp;<a href="/modules/article/bookcase.php?uid=' + jieqiUserId + '" target="_top">我的书架</a>');
		if (jieqiNewMessage > 0) {
			document.write(' | <a href="/message.php?uid=' + jieqiUserId +
				'&box=inbox" target="_top"><span class=\"hottext\">您有短信</span></a>');
		} else {
			document.write(' | <a href="/message.php?uid=' + jieqiUserId + '&box=inbox" target="_top">查看短信</a>');
		}
		document.write(' | <a href="/userdetail.php?uid=' + jieqiUserId +
			'" target="_top">查看资料</a> | <a href="/logout.php" target="_self">退出登录</a>&nbsp;');
	} else {
		var jumpurl = "";
		...
		document.write(
			'<form name="frmlogin" id="frmlogin" method="get" action="/login.php?do=submit&action=login&usecookie=1&jumpurl="' +
			jumpurl + '&jumpreferer=1>');
		document.write(
		...
		document.write(
			'<div class="frii"><input type="submit" class="int" value=" " /></div><div class="ccc"><div class="txtt"><a href="/getpass.php">忘记密码</a></div><div class="txtt"><a href="/register.php">用户注册</a></div></div></form>'
		);
	}
...
function textselect() {
	...
	document.writeln(
		"</select>翻页<input type=checkbox name=autopage id=autopage onchange=\"javascript:setAutopage();\" value=\"\" />&nbsp;夜间<input type=checkbox name=night id=night onchange=\"javascript:setNight();\" value=\"\" /></div>"
	);
}

function footer() {
	document.writeln("<p>本站所有小说为转载作品，所有章节均由网友上传，转载至本站只是为了宣传本书让更多读者欣赏。</p>");
	document.writeln("<p>Copyright &copy; 2020 xxx小说 All Rights Reserved.</p>");
	document.writeln("<p>蜀ICP备20000001号-1</p>");
	document.write('<script><!--统计代码--></script>');
...
function read_panel() {
	...
	document.writeln(
		"<div class=\"userpanel\">&nbsp;<font color=\"red\">报错：</font><a target=\"_blank\" href=\"https://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=booktxt8@163.com\">通过邮件</a>、<a href=\"/newmessage.php?tosys=1&title=" +
		booktitle + "-章节错误&content=错误章节为:" + readtitle +
...
function list_panel() {
	...
	//document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"https://zhannei.baidu.com/csesearch1.abc.com/modules/articlehttps://search1.abc.com/modules/article/search.php  .php \" id=\"sform\" target=\"_blank\"><input type=\"hidden\" name=\"s\" value=\"5334330359795686106\"><input type=\"text\" value=\"\" name=\"q\" class=\"search\" id=\"wd\" baiduSug=\"2\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>");
	document.writeln(
		"<div class=\"userpanel\">&nbsp;<font color=\"red\">报错：</font><a target=\"_blank\" href=\"https://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=youjian@qq.com\">通过邮件</a>、<a href=\"/newmessage.php?tosys=1&title=" +
		booktitle +
		"-章节错误&content=错误为:\" >站内短信</a><br /><a target=\"_blank\" href=\"/ziti.html\"><b>原图片版</b></a>&nbsp;&nbsp;<a target=\"_blank\" href=\"/jifen.html\">积分规则</a>&nbsp;&nbsp;<a target=\"_blank\" href=\"/dns.html\">解决跳到别的站</a></div>"
	);
}
...
function mark() {
	document.writeln(
		...
		bookid + "&cid=" + readid + "&ajax_request=1');\"></a></div>");
	document.writeln(
		"<div class=\"reader_mark0\"><a href=\"javascript:;\" onclick=\"showpop('/modules/article/uservote.php?id=" + bookid +
...
function ad01() {
	document.write('<script type="text/javascript" src="https://m.yanjunbo.com/js/h1.js"></script>');
}
...
function read_1_1() {
	document.write('<script id="t1388" type="text/javascript" src="./abc.js"></script>');
	("<!--内容页方形广告（左）-->");
}
