    ...
    function page_change1(data) {
      var $total_item=data.total;
        ...
        /*容器1参数*/
          ...
          $("#readNow").attr('href', "chapterContent.html?encr="+cha[0].url+"&keys="+encodeURIComponent(JSON.stringify(keys[0])));
          $('#chapters').html('');
        ...
        function change_content() {
          ...
          function page_change2(data) {
            ...
            for(var i=0;i<le;i++){
                 ...
                 page_content+="<li><div class=\"msg\"><a href='chapterContent.html?encr="+chapters[i].url+"&keys="+encodeURIComponent(JSON.stringify(keys[i]))+"'>"+chapters[i].title+"</a></div></li>"
