  ...
  function getChapterKeys(keys,str) {
    ...
    return chapterKey;
	 ...
	 $.ajax({
      ...
      $("#nav_left").html("<a href='chapterContent.html?encr="+data.chapterDetail.prev+"&keys="+encodeURIComponent(JSON.stringify(prevKeys))+"'>上一章</a>");
      $("#nav_right").html("<a href='chapterContent.html?encr="+data.chapterDetail.next+"&keys="+encodeURIComponent(JSON.stringify(nextKeys))+"'>下一章</a>");
